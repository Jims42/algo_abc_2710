...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        double mensualite = App.calculMensualite(capital, nbmois, tauxmensuel);
  ...
  partInteret=capitalRestant*tauxmensuel;
           ...
           // part_Interet(n+1) = K(n)*tm
            ...
            System.out.printf("numMois : %d // partIntérêt : %.1f // parCapital : %.1f // capitalRestant: %.0f // mensualité : %.0f  %n", numeroMois,partInteret,partCapital,capitalRestant,mensualite );

            numeroMois++;
            
        } while (numeroMois<=nbmois); 
//tableau avec utilisation d'une fonction
 System.out.println( "Voici votre tableau d'amortissement : \n"+ App.tabAmortissement(mensualite, nbmois, capital, tauxmensuel));
